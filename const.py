...
# ML SIGNAL
# =============================================================================
# Ces valeurs sont des standards. 
# Tu peux les surcharger individuellement dans chaque JSON de marché si besoin.
TARGET_CLUSTER:   int = 3
PROBA_THRESHOLD:  float = 0.6

# Liste de référence des features attendues par ton modèle XGBoost
